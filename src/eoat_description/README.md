...
- `meshes/rr_00a_b_eoat_no_camera_visual_roller52.stl`: no-camera visual mesh with only the roller component scaled to diameter 52 mm.
- `meshes/rr_00a_b_eoat_no_camera_collision_roller52.stl`: no-camera collision mesh with only the roller component scaled to diameter 52 mm.
