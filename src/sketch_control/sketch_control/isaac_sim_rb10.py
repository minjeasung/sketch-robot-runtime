...
AFT200_SIZE = (0.080, AFT200_LENGTH, 0.104)  # TCP frame box size: x, y, z
AFT200_CENTER = (0.0, -AFT200_LENGTH / 2.0, -0.0116)

EOAT_STL_PATH = "/home/minjea/sketch_robot_ws/src/eoat_description/meshes/rr_00a_b_eoat_no_camera_collision_roller52.stl"
...
ROLLER_LENGTH = 0.175   # 설치된 roller STL의 실측 축 길이
ROLLER_RADIUS = 0.026   # Φ52mm, currently installed roller
ROLLER_LONG_AXIS = "+X"
...
def _aft200_cad_to_tcp(x, y, z):
    """AFT200 CAD mesh -> TCP frame: +Z -> -Y, -X protrusion -> -Z."""
...
if TCP_PRIM_PATH is None:
    ...
    # AFT200 sensor body. CAD +Z 는 TCP -Y, CAD -X 돌출부는 TCP -Z 로 회전.
    _aft_path = TCP_PRIM_PATH + "/aft200"
    try:
        _define_stl_mesh(
            stage, _aft_path, AFT200_STL_PATH, (0.32, 0.34, 0.38),
            transform_vertex=_aft200_cad_to_tcp,
        )
