...
setup(
    ...
    entry_points={
        'console_scripts': [
            ...
            'aft200_ethernet_driver = sketch_control.aft200_ethernet_driver_node:main',
            'rbpodo_eft_bridge = sketch_control.rbpodo_eft_bridge_node:main',
            ...
            'apriltag_dual_camera_calibrator = sketch_control.apriltag_dual_camera_calibrator:main',
            'd405_eyeinhand_calibrator = sketch_control.d405_eyeinhand_calibrator:main',
            'zed_eyetohand_calibrator = sketch_control.zed_eyetohand_calibrator:main',
            'zed_eyetohand_charuco_calibrator = sketch_control.zed_eyetohand_charuco_calibrator:main',
            'd405_eyeinhand_charuco_calibrator = sketch_control.d405_eyeinhand_charuco_calibrator:main',
            'ft_threshold_setter = sketch_control.ft_threshold_setter:main',
            'interlock_flight_recorder = sketch_control.interlock_flight_recorder:main',
        ],
    },
)
