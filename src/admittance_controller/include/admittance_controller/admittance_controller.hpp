...
// Workspace safety extension for the RB10 painting profile.  Receipt times use
// a steady clock so a paused /clock cannot keep a force/compliance command alive.
struct TimedWrenchCommand
{
  geometry_msgs::msg::WrenchStamped message;
  int64_t received_steady_ns{0};
};

struct TimedComplianceCommand
{
  bool enabled{false};
  int64_t received_steady_ns{0};
};
...
protected:
  ...
  rclcpp::Subscription<std_msgs::msg::Bool>::SharedPtr compliance_enable_subscriber_;
  rclcpp::Publisher<control_msgs::msg::AdmittanceControllerState>::SharedPtr s_publisher_;
  rclcpp::Publisher<std_msgs::msg::Bool>::SharedPtr compliance_active_publisher_;
  rclcpp::Publisher<std_msgs::msg::Bool>::SharedPtr limit_reached_publisher_;
  rclcpp::Publisher<std_msgs::msg::Bool>::SharedPtr rate_saturated_publisher_;
  rclcpp::Publisher<std_msgs::msg::Float64>::SharedPtr normal_trim_publisher_;
  rclcpp::Publisher<std_msgs::msg::Bool>::SharedPtr roller_contact_valid_publisher_;
  rclcpp::Publisher<std_msgs::msg::Bool>::SharedPtr roller_correction_active_publisher_;
  rclcpp::Publisher<std_msgs::msg::Bool>::SharedPtr roller_limit_reached_publisher_;
  rclcpp::Publisher<std_msgs::msg::Bool>::SharedPtr roller_rate_saturated_publisher_;
  rclcpp::Publisher<std_msgs::msg::Float64>::SharedPtr roller_contact_torque_publisher_;
  rclcpp::Publisher<std_msgs::msg::Float64>::SharedPtr roller_cop_offset_publisher_;
  rclcpp::Publisher<std_msgs::msg::Float64>::SharedPtr roller_rotation_trim_publisher_;
  rclcpp::Publisher<std_msgs::msg::Float64>::SharedPtr roller_commanded_trim_publisher_;
  rclcpp::Publisher<std_msgs::msg::Bool>::SharedPtr roller_soft_limit_publisher_;
  ...
  realtime_tools::RealtimeThreadSafeBox<TimedWrenchCommand> input_wrench_command_;
  realtime_tools::RealtimeThreadSafeBox<TimedComplianceCommand> input_compliance_enable_;
  ...
  bool compliance_active_{false};
  int64_t last_wrench_received_steady_ns_{0};
  int64_t last_compliance_received_steady_ns_{0};
